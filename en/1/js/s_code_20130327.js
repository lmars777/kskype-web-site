...
/*global document, event, s_allowLocal, s_allowSurvey, s_impression, window, location, s_referrer_mask, s_pageURL_mask*/
...
function s_doPlugins(s) {
  ...
  try {
    if (typeof s.eVar41 !== "undefined" &&
      ...
      s.date_now = new Date();
      s.date_now_utc = new Date(s.date_now.getUTCFullYear(),
                                s.date_now.getUTCMonth(),
                                s.date_now.getUTCDate(),
                                s.date_now.getUTCHours(),
                                s.date_now.getUTCMinutes(),
                                s.date_now.getUTCSeconds());

      if (s.reg_days_ago === 0) { // same day
        s.eVar40 = "in day of registration";
      } else {
        if (s.date_now_utc.getDay() - s.reg_days_ago >= 0) { // this week
          s.eVar40 = "in week of registration";
        } else {
          if (s.date_now_utc.getDate() - s.reg_days_ago >= 0) { // this month
            s.eVar40 = "in month of registration";
          } else {
            s.eVar40 = "registration in previous month";
          }
        }
      }
      s.date_now = "";
...
/*
     FILE ARCHIVED ON 12:16:31 Apr 30, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:02:45 Dec 02, 2024.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 6.947
  LoadShardBlock: 392.231 (3)
  PetaboxLoader3.datanode: 92.278 (4)
  PetaboxLoader3.resolve: 400.567 (2)
  load_resource: 139.636
*/