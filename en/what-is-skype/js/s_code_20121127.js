  ...
  if (typeof s.eVar41 !== "undefined" &&
    ...
    if (s.events.indexOf('purchase') !== -1 &&
      ...
      if (s.reg_days_ago === 0) {
        ...
        if (s.date_now_utc.getDay() - s.reg_days_ago >= 0) {
          s.eVar40 = "in week of registration";
        } else {
          if (s.date_now_utc.getDate() - s.reg_days_ago >= 0) {
...
/*
     FILE ARCHIVED ON 20:07:20 Nov 28, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:18:26 Oct 29, 2024.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 5.8
  LoadShardBlock: 65.643 (3)
  PetaboxLoader3.datanode: 100.2 (5)
  load_resource: 2842.505 (2)
  PetaboxLoader3.resolve: 2765.366 (2)
*/