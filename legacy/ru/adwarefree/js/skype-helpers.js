        ...
        for (var i=0; i < formsOnPage.length; i++)
            {
                ...
                {
                    if(buttons[0].className.indexOf('submitButton') > -1)
                    {
                        var buttonclasses = buttons[0].className.split(" ");
                        var buttonvalue = buttons[0].innerHTML;
                        ...
                        var buttonId = "submitButton_"+i;
                        wrapper.setAttribute("id", buttonId);
                        a.appendChild(innerspan);
                        a.setAttribute("href","#");
                        innerspan.innerHTML = buttonvalue;
                        buttons[0].parentNode.appendChild(wrapper);
                        var oldbutton = buttons[0].parentNode.removeChild(buttons[0]);                
                    }
                }
            }
...
/*
     FILE ARCHIVED ON 15:07:14 Feb 06, 2008 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.008
  cdx.remote: 5.848
  LoadShardBlock: 122.086 (3)
  PetaboxLoader3.datanode: 158.788 (6)
  load_resource: 89.636
  PetaboxLoader3.resolve: 45.584
*/