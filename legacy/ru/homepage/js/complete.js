...
{chann_source="VIRALFACTORY";}};return{detectTracking:function()
{try
{if(readCookie("channel_source")!=null)
{return;}
isNaturalTraffic();isAffiliateTraffic();isPaidSearch();isYahooPaidSearch();isMSNPaidSearch();isTafClient();isTafWeb();isHPackard();isEbayFreeCalls();isViralFactory();if(chann_source!="")
...
/*
     FILE ARCHIVED ON 19:22:00 Feb 17, 2009 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:42:05 Oct 30, 2024.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 23.209
  LoadShardBlock: 115.5 (3)
  PetaboxLoader3.datanode: 80.622 (4)
  PetaboxLoader3.resolve: 86.903 (2)
  load_resource: 87.189
*/