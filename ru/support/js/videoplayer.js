...
SKYPE.flash._player = function(url) {
	...
	var writeIPhone = function(divId, url, width, height) {
		if (_getById(divId)) {
			_getById(divId).innerHTML = '<embed src="'+url+'" target="myself" width="'+width+'" height="'+height+'" controller="false" autoplay="false" scale="1" cache="true" type="video/quicktime" pluginspage="https://web.archive.org/web/20130606155630/http://www.apple.com/quicktime/download/"/>';
		}
	};
...
SKYPE.flash.VideoPlayer         = SKYPE.flash._player("https://web.archive.org/web/20130606155630/http://download.skype.com/share/videos/player.swf");
SKYPE.flash.BusinessVideoPlayer = SKYPE.flash._player("https://web.archive.org/web/20130606155630/http://download.skype.com/share/videos/business/player.swf");
...
/*
     FILE ARCHIVED ON 15:56:30 Jun 06, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:04:09 Sep 29, 2024.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 11.734
  LoadShardBlock: 89.618 (3)
  PetaboxLoader3.datanode: 144.885 (5)
  load_resource: 150.834 (2)
  PetaboxLoader3.resolve: 78.394
*/